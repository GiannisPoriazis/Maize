...
export const enum SignalRAction {
  ConnectionFailed = 0,
  AdminSettingsUpdated = 1,
  AnnouncementCreated = 2,
}

export enum ModalType {
  VehicleBookingEvent = 0,
  Confirmation = 1
}

export const enum NotificationPhrases {
  SignalRConnectionFailed = 'signalR_connection_failed',
  SignalRSettingsUpdated = 'signalR_settings_updated',
  InvalidUsernameOrPassword = 'invalid_username_password',
  ProvideYourEmailAddress = 'provide_your_email_address',
  ResetTokenSent = 'reset_token_sent',
  SignInHeader = 'sign_in_header',
  ResetYourPassword = 'reset_password',
  LogoutSessionExpired = 'logout_session_expired',
  ...
  VehicleBookingCreated = 'vehicle_booking_created',
  VehicleBookingUpdated = 'vehicle_booking_updated',
  VehicleBookingDeleted = 'vehicle_booking_deleted',
  ProfileUpdated = 'profile_updated',
  SettingsUpdated = 'settings_updated',
  SearchUserNotFound = 'search_user_not_found',
  SearchBookingNotFound = 'search_vehicle_booking_not_found',
  SearchClientNotFound = 'search_client_not_found',
  SearchVehicleNotFound = 'search_vehicle_not_found',
  SecurityPinDestroyed = 'security_pin_destroyed',
  SuccessfulUpdate = 'successful_update',
  VehicleTypeMissing = 'vehicle_type_missing',
  VehicleSpecialRateStartDateMissing = 'vehicle_special_rate_start_date_missing',
  VehicleSpecialRateVehicleIdMissing = 'vehicle_special_rate_vehicle_id_missing',
  VehicleSpecialRateVehicleModelIdMissing = 'vehicle_special_rate_vehicle_model_id_missing',
  VehicleSpecialRateVehicleCategoryIdMissing = 'vehicle_special_rate_vehicle_category_id_missing',
  VehicleSpecialRateVehicleTypeIdMissing = 'vehicle_special_rate_vehicle_type_id_missing',
  VehicleSpecialRateConflictingOffer = 'vehicle_special_rate_conflicting_offer',
  VehicleCategoryMissing = 'vehicle_category_missing',
  CarRentalStationCreated = 'carRental_station_created',
  CarRentalStationUpdated = 'carRental_station_updated',
  CarRentalStationDeleted = 'carRental_station_deleted',
  SearchStationNotFound = 'search_station_not_found',
  CompanyAnnouncementCreated = 'company_announcement_created',
  CompanyAnnouncementDeleted = 'company_announcement_deleted',
  CompanyAnnouncementUpdated = 'company_announcement_updated',
  ModuleActivated = 'module_activated',
...
export const CompanyTypes = [
  { 
    key: 'company_type_car_rental',
    value: 0 
  }
]

export const LockScreenTimeouts = [
  { 
    key: '10',
    value: 0 
  },
...
export const VehicleStates = [
  { 
    key: 'ready_to_go_status',
    value: 0 
  },
  { 
    key: 'hard_hold_status',
    value: 1 
  }
]

export const VehiclePoolTypes = [
  {
    key: 'car_rental_pool_type',
    value: 0 
  }
]

export const VehicleGears = [
  {
    key: 'manual_gears',
    value: 0
  },
